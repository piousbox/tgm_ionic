...
var AppComponent = /** @class */ (function () {
    function AppComponent(appService, fb, menu, nativeStorage, ngZone, platform, router, splashScreen, statusBar, httpClient, loadingController) {
        ...
        this.env = JSON.stringify(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"]);
    ...
    AppComponent.prototype.doFacebookLogin = function () {
        ...
        if (this.platform.is('pwa')) {
            FB.init({ appId: _environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].fb_app_id,
                xfbml: true,
                version: 'v2.8',
            });
        }
